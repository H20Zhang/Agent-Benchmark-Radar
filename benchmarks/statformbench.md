...
> **发布时最佳结果（待核验）** · 基准记录日期：2026-09-02<br>
> 尚未核验原始发布版本中可定位到模型、指标和协议的最佳成绩。 [原始来源](https://arxiv.org/abs/2609.01982)<br>
...
相较 DS-1000 的代码实现和 Spider 的查询生成，它减少了“用户已经给出正确分析目标”这个默认前提。与端到端 DataSciBench 互补：当最后结果出错时，可以先检查方法类别、变量集合和角色是否在执行之前就选错。
